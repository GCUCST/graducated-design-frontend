...
<el-menu  text-color="white" background-color="#2A333C" default-active="1-4-1" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose" :collapse="isCollapse">
  
  <!-- 展开按钮 -->
  <el-menu-item index="0">
    <i class="el-icon-d-arrow-right" @click="isCollapse=!isCollapse"></i>
